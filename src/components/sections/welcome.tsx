...
const Welcome: React.FC<Props> = ({
  ...
  return (
    <div className="h-full w-full flex-shrink-0 snap-start flex flex-col items-start justify-center p-7 transition-all duration-700 ease-in-out">
      ...
      <p className={`text-2xl ${paid ? 'text-[var(--text-color-2)] italic font-semibold text-center' : 'text-gray-600'} transition-all duration-700 ease-in-out`}>GhostWeb Develpoer and Designer.</p>
