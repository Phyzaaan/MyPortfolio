...
const Welcome: React.FC<Props> = ({
  ...
  return (
    <div className="h-full w-full flex-shrink-0 snap-start flex flex-col items-start justify-center p-4 overflow-hidden">
      <p className={`text-xl mb-0 ${paid ? 'font-semibold' : ''}`}>I am</p>
      <h1 className={`text-6xl font-extrabold mb-4 ml-7 leading-tight ${paid ? 'text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-pink-500 drop-shadow ml-10' : ''}`}>Phantom</h1>
