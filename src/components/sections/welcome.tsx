...
const Welcome: React.FC<Props> = ({
  ...
  return (
    <div className="h-full w-full flex-shrink-0 snap-start flex flex-col items-start justify-center p-7 transition-all duration-300 ease-in-out">
      ...
      <div className={`text-xl ${paid ? 'text-[var(--text-color)]' : 'text-gray-600'} transition-all duration-150 ease-in-out`}>
      ...
      <div className='h-full w-full flex justify-center items-end'>
        <p className='text-[var(--text-color)]/50 text-center font-semibold text-2xl abslout b-0 pointer-events-none transition-all duration-150 ease-in-out' >Don't Scroll Down</p>
      </div>
    </div>
  );
};
